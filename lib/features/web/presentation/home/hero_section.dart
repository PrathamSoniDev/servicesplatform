...
class HeroSection extends StatelessWidget {
  const HeroSection({super.key, this.imagePath, this.titile, this.subtitle});
  final String? imagePath, titile, subtitle;
  final bool? showButtons = true, showGradientTitle = true;
