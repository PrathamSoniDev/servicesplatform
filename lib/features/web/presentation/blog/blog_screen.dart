...
//           color:
//               active ? Colors.white.withValues(alpha: .1) : Colors.transparent,
...
class _BlogScreenState extends State<BlogScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: Colors.black,
      // FIX: Changed from SingleChildScrollView to Stack to support Positioned widgets
      body: Stack(
        children: [
          // 1. SCROLLABLE CONTENT (Background Layer)
          SingleChildScrollView(
            child: Column(
              children: [
                // Add spacing at top so content isn't hidden behind the Nav Bar
                // Adjust '80' to match the height of your TopNavBar
                const SizedBox(height: 80),
          ...
          // 2. TOP NAV BAR (Overlay Layer)
          // Since TopNavBar likely returns a Positioned widget, it must be
          // a direct child of this Stack.
          TopNavBar(
            activeIndex: 4,
            onHome: () => context.go('/home'),
            onDesigns: () {},
  ...
  // ... (Keep the rest of your methods: _buildTrendingSection, _buildPaginationControls, etc. exactly the same)
  Widget _buildTrendingSection(double width, bool isMobile) {
    return Column(
      children: [
        GridView.builder(
